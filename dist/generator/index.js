...
class TestGenerator {
     ...
     */
    async generateTestForScenario(scenario, feature, options) {
     ...
     */
    async generateTestsForFeatures(parsedFeatures, options) {
        const tests = [];
     ...
     */
    buildPrompt(scenario, feature, options) {
...
Generate ONLY the test code without any explanations or markdown formatting. The code should be ready to run.`;
     ...
     */
    getFrameworkInstructions(framework, language) {
        const instructions = {
            playwright: {
                typescript: `
...
- Handle async operations properly`
     ...
     */
    generateFilePath(scenario, options) {
     ...
     */
    getCustomPrompt(scenarioType) {
        return this.defaultPrompts[scenarioType] || '';
    }
    /**
     * Validate generated test code
     */
    validateTestCode(code, framework, language) {

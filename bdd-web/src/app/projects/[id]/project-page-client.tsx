        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex gap-3">
              <Button variant="outline" className="px-3 py-2" onClick={() => router.back()}>
                ← Back
              </Button>
              <Button onClick={handleExport} className="px-4 py-2 bg-[#ff6e6c] hover:bg-[#e55a58] text-white text-sm font-medium">
                Export
              </Button>
              <Button onClick={handleDelete} className="px-4 py-2 bg-[#67568c] hover:bg-[#5a4a7a] text-white text-sm font-medium">
                Delete
              </Button>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-[#F9FAFA] rounded-lg p-4 border border-gray-200">
              <h3 className="text-lg font-semibold text-[#11235] mb-3">Upload Feature File</h3>
